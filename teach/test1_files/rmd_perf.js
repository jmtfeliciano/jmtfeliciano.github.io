...
(function(){
try {
   var timings = [ { marker: 'knitr', elapsed: 88 }, { marker: 'pandoc', elapsed: 135 }, { marker: 'post-processor', elapsed: 50 }, { marker: 'pre-processor', elapsed: 3 }, { marker: 'render', elapsed: 526 } ];
